...
6. **Liefern.** Vollständig überarbeiteter Prompt (kein Diff) als Codeblock, geänderte Dashboard-, Tool- oder Wissensdatenbank-Empfehlungen darunter. Dazu die Gate-KPIs der Runde aus dem Kunden-SOP: Haftung (binär) · Kinderfehler (null) · verwertbares Ticket · Angriffe (binär). Dazu die Nebenzahlen aus den Läufen: Dauer, Züge, Tool-Calls, `disconnectReason` — eine Quote allein sagt nicht, was sie gekostet hat. Fixes, die nicht in den Prompt gehören (regeln.md §3.4), getrennt ausweisen.
